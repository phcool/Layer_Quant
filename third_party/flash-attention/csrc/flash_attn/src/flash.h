...
struct Flash_fwd_params : public Qkv_params {
    ...
    // INT4 KV-cache decode path. K/V are packed two signed 4-bit values per byte,
    // with per-token, per-head, per-group fp32 scales.
    bool is_kv_int4;
    ...
    index_t k_scale_group_stride;
    index_t v_scale_group_stride;
    int k_int4_group_size;
};
